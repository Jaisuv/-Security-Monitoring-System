...
PlayH264::PlayH264(QString filename)
{
    this->isRun=false;
    this->interval=80;
    this->speedFactor=2;
...
double PlayH264::getSpeedFactor() const
{
    return speedFactor;
}

void PlayH264::setSpeedFactor(double value)
{
    speedFactor = static_cast<unsigned long>(value);
}
...
void PlayH264::changeSpeed(int index)
{
    this->speedFactor=static_cast<unsigned long>(index+1);
}
