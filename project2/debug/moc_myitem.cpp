...
QT_MOC_LITERAL(3, 17, 8) // "turnPage"

    },
    "MyItem\0stopMove\0\0turnPage"
};
...
void MyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyItem::stopMove)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyItem::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyItem::turnPage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyItem::stopMove()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyItem::turnPage()
{
