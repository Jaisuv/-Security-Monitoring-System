...
QT_MOC_LITERAL(1, 10, 13), // "RegtoLoginWin"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10), // "back2Login"
QT_MOC_LITERAL(4, 36, 15), // "pwd_EchoMode_Sw"
QT_MOC_LITERAL(5, 52, 17), // "cfpwd_EchoMode_Sw"
QT_MOC_LITERAL(6, 70, 14), // "clickCancelBtn"
QT_MOC_LITERAL(7, 85, 6) // "Regist"

    },
    "RegistWin\0RegtoLoginWin\0\0back2Login\0"
    "pwd_EchoMode_Sw\0cfpwd_EchoMode_Sw\0"
    "clickCancelBtn\0Regist"
};
...
void RegistWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RegtoLoginWin(); break;
        case 1: _t->back2Login((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->pwd_EchoMode_Sw(); break;
        case 3: _t->cfpwd_EchoMode_Sw(); break;
        case 4: _t->clickCancelBtn(); break;
        case 5: _t->Regist(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (RegistWin::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegistWin::RegtoLoginWin)) {
                *result = 0;
                return;
            }
        }
